...
// /// A 2-dimensional sparse binary matrix.
// /// We don't want to make arbitrary indexing fast, we just want a list of
...
impl SparseBinaryMatrix {
    ...
    /// Returns an iterator of the indices of the array's 1s. These
